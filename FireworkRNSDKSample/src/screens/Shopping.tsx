...
function Shopping() {
  ...
  const [playlistInputModalVisible, setPlaylistInputModalVisible] =
    useState(false);
  const [channelId, setChannelId] = useState<string>(defaultShoppingPlaylist.channelId);
  const [playlistId, setPlaylistId] = useState<string>(defaultShoppingPlaylist.playlistId);
